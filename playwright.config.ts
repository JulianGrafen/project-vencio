...
const webServer: PlaywrightTestConfig["webServer"] = [
  {
    command:
      "yarn workspace @calcom/web copy-app-store-static && NEXT_PUBLIC_IS_E2E=1 PVS_SYNC_ENABLED=1 NODE_OPTIONS='--dns-result-order=ipv4first' yarn workspace @calcom/web start -p 3000",
    port: 3000,
    timeout: 60_000,
