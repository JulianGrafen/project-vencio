...
3. Set the Redirect URL for OAuth `<teeth.al URL>/api/integrations/zoho-bigin/callback` replacing teeth.al URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [teeth.al](https://cal.com) app store.
