...
- Add [teeth.al](https://cal.com) booking calendar to any WordPress page/post with a simple shortcode.
- Display your [teeth.al](https://cal.com) booking calendar inline or in a popup.
