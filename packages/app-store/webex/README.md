...
9. Set the Redirect URI as `<teeth.al URL>/api/integrations/webex/callback` replacing [teeth.al](https://cal.com) URL with the URI at which your application runs.
