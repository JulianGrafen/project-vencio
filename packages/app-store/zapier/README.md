...
**Note:** This is a redirect app. End users should connect teeth.al to Zapier directly via the Zapier Integrations page: https://zapier.com/apps/calcom/integrations

The Zapier app in teeth.al now functions as a redirect app that takes users directly to Zapier's integration page. No local setup or OAuth configuration is required.

## How It Works

1. **User clicks "Visit"** → Opens Zapier integrations page
2. **User sets up automation** → Directly on Zapier's platform
3. **No teeth.al credentials needed** → Users authenticate directly with Zapier
