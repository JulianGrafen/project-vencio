...
6. Under "Add client" give your client a name, e.g. "teeth.al".
7. Set the Redirection URI as `<teeth.al URL>/api/integrations/nextcloudtalk/callback` replacing [teeth.al](https://cal.com) URL with the URI at which your application runs.
8. Click "Add".
