...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://teeth.al";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "teeth.al";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@teeth.al";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "teeth.al";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "teeth";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "teeth.al";
...
export const LOGO = "/teeth-al-logo.svg";
export const LOGO_DARK = "/teeth-al-logo-dark.svg";
export const LOGO_ICON = "/teeth-al-icon.svg";
