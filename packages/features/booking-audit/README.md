...
The Booking Audit System tracks all actions and changes related to bookings in teeth.al. The architecture is built around two core tables (`AuditActor` and `BookingAudit`) that work together to maintain a complete, immutable audit trail.
...
- **USER**: Registered teeth.al users
...
- **WEBAPP**: teeth.al web application
...
- **User Actor**: Registered teeth.al user
